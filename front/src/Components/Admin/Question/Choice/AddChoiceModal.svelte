<script lang="ts">
    ...
    onMount(() => {
        const data = componentModalStore.getData() as { questionId: number };
    ...
    async function validateAddingBeforeSubmit() {
        ...
        choiceApi
            .add(questionId, txtDescription, isAnswer)
            .then((res) => {
                if (res.success) {
                    flashStore.showSuccessFlash(CommonMessage.SUCCESS_ADDED);
...
<div class="modal-container">
    <div class="modal-header">
        <div class="title">Add Choice</div>
    </div>
